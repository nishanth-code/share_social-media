...
/** @public */
export declare interface Block<TChild = Span> {
  _type: string
  _key: string
  style: string
  children: TChild[]
...
export declare interface BlockSchemaType extends ObjectSchemaType {
  fields: [BlockChildrenObjectField, StyleObjectField, ListObjectField, ...ObjectField[]]
  options?: BlockOptions
}
 ...
 * @public
 */
export declare type BlockValidator = (
  block: Block,
...
/** @internal */
export declare function isBlock<T = Span>(value: unknown): value is Block<T>
...
/** @public */
export declare interface MarkDefinition {
  [key: string]: unknown
  _type: string
  _key: string
}
...
/** @public */
export declare interface SpanDefinition extends BaseSchemaDefinition {
  type: 'span'
  options?: SpanOptions
}

/** @public */
export declare interface SpanOptions extends StringOptions {}
